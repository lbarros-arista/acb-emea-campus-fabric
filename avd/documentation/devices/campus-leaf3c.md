...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 172.20.2.8/16 | 172.20.0.1 |

##### IPv6

| Management Interface | Description | Type | VRF | IPv6 Address | IPv6 Gateway |
| -------------------- | ----------- | ---- | --- | ------------ | ------------ |
| Management1 | oob_management | oob | MGMT | fd00:6265:b424:a8b8::2:8/64 | fd00:6265:b424:a8b8::1 |
...
interface Management1
   ...
   no shutdown
   vrf MGMT
   ip address 172.20.2.8/16
   ipv6 enable
   ipv6 address fd00:6265:b424:a8b8::2:8/64
   no lldp transmit
   no lldp receive
```
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet97/1 | CAMPUS-LEAF3A_Ethernet97/3 | *trunk | *10,310,320,330 | *- | *- | 971 |
| Ethernet97/2 | CAMPUS-LEAF3B_Ethernet97/3 | *trunk | *10,310,320,330 | *- | *- | 971 |
...
interface Ethernet97/1
   description CAMPUS-LEAF3A_Ethernet97/3
   no shutdown
   channel-group 971 mode active
!
interface Ethernet97/2
   description CAMPUS-LEAF3B_Ethernet97/3
   no shutdown
   channel-group 971 mode active
```
